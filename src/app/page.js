...
// Palet Warna Profesional untuk 7 Klaster
const PALET_WARNA = [
  "#3b82f6",
  "#10b981",
  "#f97316",
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      .then(([dataKlaster, dataProfil, dataGeo, dataGabunganCsv]) => {
        ...
        // --- PERBAIKAN TOTAL: Mengolah data CSV dengan JavaScript murni ---
  ...
  // ... Sisa JSX Anda (return (...)) sama persis seperti kode sebelumnya ...
  // ... Saya akan tempelkan lagi di sini agar lengkap dan tidak ada kebingungan ...
